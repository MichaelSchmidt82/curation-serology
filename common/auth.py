...
def get_impersonation_credentials(target_principal,
    ...
    if not target_scopes:
        LOGGER.warning(f"Using default scopes: {consts.DEFAULT_SCOPES}")
        target_scopes = consts.DEFAULT_SCOPES
    ...
    if not isinstance(target_scopes, (list, tuple)):
        LOGGER.warning(f"Target scopes requires an iterable.  Currently "
                       ...
                       f"default scopes: {consts.DEFAULT_SCOPES}.")
        target_scopes = consts.DEFAULT_SCOPES
    ...
    if key_file:
        ...
        return impersonated_credentials.Credentials(
            ...
            lifetime=consts.IMPERSONATION_LIFETIME)
